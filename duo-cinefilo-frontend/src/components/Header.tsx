    // import { Search, User as UserIcon, LogOut, Film, Calendar, Briefcase, MapPin } from 'lucide-react';
    // import { User } from '../App';
    // import { Button } from './ui/button';
    import { Search,  Film, Calendar, Briefcase } from 'lucide-react';
...
// export function Header({ user, onNavigate, onLogout, searchQuery, onSearchChange }: HeaderProps) {
// export function Header({ user, onNavigate, onLogout, searchQuery, onSearchChange }: HeaderProps) {
